...
// GenerateTokenFromString returns a token from a data string
...
// VerifyToken returns true if token is verified and false if not
...
// Expired returns true if expired and false if not
