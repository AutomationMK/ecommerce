...
// writeJSON takes a given status, data, and extra headers then writes
// a JSON response to the response writer along with extra headers
...
// passwordMatches checks if the hashed input password matches the hashed password in the database
