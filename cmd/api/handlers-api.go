...
// GetWidgetByID gets the widget by a url param id
...
// CreateCustomerAndSubscribe takes json post request body to create and subscribe customer
...
// CreateAuthToken authenticates a user when login is
// successfull
...
// authenticateToken checks the validity of the Authorization Header
// the user connected to the token gets returned
...
// CheckAuthentication checks if a request is authenticated
...
func (app *application) VirtualTerminalPaymentSucceeded(w http.ResponseWriter, r *http.Request) {
	var txnData struct {
		...
		ExpiryMonth     int    `json:"expiry_month"`
		ExpiryYear      int    `json:"expiry_yeor"`
		LastFour        string `json:"last_four"`
	}
...
// ResetPassword resets the password of a user based on json payload of email and new password
