...
## restart: stops and starts the frontend and backend of the running application
restart: stop start

## restart_front: stops and starts the frontend of the running application
restart_front: stop_front start_front

## restart_back: stops and starts the backend of the running application
